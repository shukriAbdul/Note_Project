...
const showNoteArea = () => {
  ...
  //   tittle.style.background = "green"; waa qeybta title ka
  //   note_text.style.background = "green"; waa qeybta note ka ama text Area

  //   note_area.style.background = "red";  waa main ka all classka ku dhexjiraan
